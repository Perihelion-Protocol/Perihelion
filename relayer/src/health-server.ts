...
export class HealthServer {
  ...
  private handleMetrics(res: ServerResponse): void {
    ...
    const lines = [
      ...
      "",
      "# HELP relayer_already_delivered_total Messages found already delivered on the destination (idempotency short-circuit)",
      "# TYPE relayer_already_delivered_total counter",
      `relayer_already_delivered_total ${m.alreadyDelivered}`,
      "",
      "# HELP relayer_failed_total Delivery attempts that threw an error",
      "# TYPE relayer_failed_total counter",
